...
import { Shield, Camera, Eye, Lock, Bell, Wifi, ArrowLeft } from "lucide-react"
          ...
          <div className="container mx-auto px-4">
            ...
            >
              <motion.div
                ...
                className="mb-6"
              >
                <Camera className="h-20 w-20 text-[#5ea3a3]" />
              </motion.div>
              <h1 className="text-4xl md:text-5xl font-bold mb-6">{t("videoSurvTitle")}</h1>
              <p className="text-lg mb-8">{t("videoSurvSubtitle")}</p>
              <motion.div
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <motion.div
              ...
              transition={{ duration: 0.7 }}
            >
              <h2 className="text-3xl font-bold text-[#0e2c47] mb-4">{t("securitySolutions")}</h2>
              <p className="max-w-2xl mx-auto text-gray-600">{t("securitySolutionsDesc")}</p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-[#0e2c47] mb-3">{t("hdCameras")}</h3>
                <p className="text-gray-600">{t("hdCamerasDesc")}</p>
              ...
              >
                ...
                <h3 className="text-xl font-bold text-[#0e2c47] mb-3">{t("remoteAccess")}</h3>
                <p className="text-gray-600">{t("remoteAccessDesc")}</p>
                <ul className="space-y-2 mt-4">
                  <li className="flex items-center">
                    <svg
                      className="h-5 w-5 text-[#5ea3a3] mr-2"
              ...
              >
                ...
                <h3 className="text-xl font-bold text-[#0e2c47] mb-3">{t("smartAlerts")}</h3>
                <p className="text-gray-600">{t("smartAlertsDesc")}</p>
                <ul className="space-y-2 mt-4">
                  <li className="flex items-center">
                    <svg
                      className="h-5 w-5 text-[#5ea3a3] mr-2"
              ...
              >
                ...
                <h3 className="text-xl font-bold text-[#0e2c47] mb-3">{t("secureStorage")}</h3>
                <p className="text-gray-600">{t("secureStorageDesc")}</p>
                <ul className="space-y-2 mt-4">
                  <li className="flex items-center">
                    <svg
                      className="h-5 w-5 text-[#5ea3a3] mr-2"
              ...
              >
                ...
                <h3 className="text-xl font-bold text-[#0e2c47] mb-3">{t("professionalInstall")}</h3>
                <p className="text-gray-600">{t("professionalInstallDesc")}</p>
                <ul className="space-y-2 mt-4">
                  <li className="flex items-center">
                    <svg
                      className="h-5 w-5 text-[#5ea3a3] mr-2"
                  ...
                  <li className="flex items-center">
                    ...
                    <span>{t("professionalMounting")}</span>
                  </li>
                </ul>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-xl font-bold text-[#0e2c47] mb-3">{t("ongoingSupport")}</h3>
                ...
                <ul className="space-y-2 mt-4">
                  ...
                  <li className="flex items-center">
                    ...
                    <span>{t("regularMaintenance")}</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                      className="h-5 w-5 text-[#5ea3a3] mr-2"
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <motion.div
              ...
              transition={{ duration: 0.7 }}
            >
              <h2 className="text-3xl font-bold text-[#0e2c47] mb-4">{t("industriesServe")}</h2>
              <p className="max-w-2xl mx-auto text-gray-600">{t("industriesServeDesc")}</p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <motion.div
                  ...
                  whileHover={{ y: -10 }}
                >
                  <h3 className="text-xl font-bold text-[#0e2c47] mb-3">{industry.name}</h3>
        ...
        <section className="bg-[#0e2c47] text-white py-16 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            >
              ...
              <p className="max-w-2xl mx-auto mb-8">{t("securityConsultation")}</p>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
